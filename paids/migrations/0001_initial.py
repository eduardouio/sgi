# Generated by Django 2.1.5 on 2019-12-19 19:23
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='id_documento_pago',
            field=models.ForeignKey(blank=True, db_column='id_documento_pago', db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='paids.PaidInvoice'),
        ),
        migrations.AddField(
            model_name='historicalpaidinvoicedetail',
            name='id_gastos_nacionalizacion',
            field=models.ForeignKey(blank=True, db_column='id_gastos_nacionalizacion', db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='paids.Expense'),
        ),
        migrations.AlterUniqueTogether(
            name='rateexpense',
