...
select 
    ...
    DATEDIFF(o.fecha_llegada_cliente, o.fecha_arribo) as dias_transito_puerto,
    0 dias_permanencia_almagro,
    DATEDIFF(o.fecha_llegada_cliente, o.fecha_arribo) dias_transito,
...
o.fecha_arribo,
o.fecha_ingreso_almacenera,
DATEDIFF(o.fecha_ingreso_almacenera, o.fecha_arribo) as dias_transito_puerto,
DATEDIFF(pc.fecha_llegada_cliente, o.fecha_ingreso_almacenera) dias_permanencia_almagro,
DATEDIFF(pc.fecha_llegada_cliente, o.fecha_arribo) dias_transito,
