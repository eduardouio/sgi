...
from .views import (ICEAnexoReportTemplateView, ICEReportTemplateView,
					...
					CurrentNationalizationAPI,ActiveOrdersAPI
				)
...
urlpatterns = [
    ...
    path('procesos-activos/api/', CurrentNationalizationAPI.as_view(), name='reporte-nacionalizaciones-api'),
	path('activos/api/', ActiveOrdersAPI.as_view(), name='reporte-pedidos-activos-api'),
]
