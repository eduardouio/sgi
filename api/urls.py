...
urlpatterns = [
    ...
    path('order/close/<nro_pedido>/', OrderCloseView.as_view(), name="cerrarpedido" ),
    # OrderInvoice
    ...
    # Labels 
    path('labels/create/', LabelCreateView.as_view(), name='create-suppliers' ),
    path('labels/delete/<pk>/', LabelDeleteView.as_view(), name='delete-suppliers' ),
