...
class Partial(models.Model):
    ...
    fodinfa_pagado = models.DecimalField(max_digits=10, decimal_places=3, blank=True, default=0)
    ice_advalorem = models.DecimalField(max_digits=10, decimal_places=3, blank=True, default=0)
    ice_advalorem_reliquidado = models.DecimalField(max_digits=12, decimal_places=3, default=0)
    ice_advalorem_pagado = models.DecimalField(max_digits=10, decimal_places=3, blank=True, default=0)
    ice_especifico = models.DecimalField(max_digits=10, decimal_places=3, blank=True, default=0)
    ice_especifico_pagado = models.DecimalField(max_digits=10, decimal_places=3, blank=True, default=0)
    iva = models.DecimalField(max_digits=10, decimal_places=3, blank=True, default=0)
    iva_pagado = models.DecimalField(max_digits=10, decimal_places=3, blank=True, default=0)
    arancel_advalorem_pagar = models.DecimalField(max_digits=16, decimal_places=3, blank=True, default=0)
    arancel_advalorem_pagar_pagado = models.DecimalField(max_digits=16, decimal_places=3, blank=True, default=0)
    arancel_especifico_pagar_pagado = models.DecimalField(max_digits=16, decimal_places=3, blank=True, default=0)
    arancel_especifico_pagar = models.DecimalField(max_digits=16, decimal_places=3, blank=True, default=0)
    base_arancel_advalorem = models.DecimalField(max_digits=16, decimal_places=3, blank=True, default=0)
    base_arancel_especifico = models.DecimalField(max_digits=16, decimal_places=3, blank=True, default=0)
    base_ice_especifico = models.DecimalField(max_digits=16, decimal_places=3, blank=True, default=0)
    base_ice_advalorem = models.DecimalField(max_digits=16, decimal_places=3, blank=True, default=0)
    porcentaje_ice_advalorem = models.DecimalField(max_digits=16, decimal_places=3, blank=True, default=0)
    base_iva = models.DecimalField(max_digits=16, decimal_places=3, blank=True, default=0)
    base_fodinfa = models.DecimalField(max_digits=16, decimal_places=3, blank=True, default=0)
    base_etiquetas = models.DecimalField(max_digits=16, decimal_places=8, blank=True, default=0)
