...
DATOS_EMPRESAS = {
    'test': {
        ...
        'url_bootle_sap': 'http://192.168.0.198:8000/cordovez/',
        'admin_title': 'TEST',
    ...
    'cordovez': {
        ...
        'url_app_importaciones': 'http://179.49.60.158:8888/cordovez/',
        'url_bootle_sap': 'http://127.0.0.1:8000/cordovez/',
    ...
    'imnac': {
        ...
        'url_bootle_sap': 'http://127.0.0.1:8000/imnac/',
        'admin_title': 'IMNAC',
        'database': 'imnacApp',
        'db_host': 'localhost',
        'db_port': '3306',
    ...
    'vid': {
        ...
        'url_bootle_sap': 'http://127.0.0.1:8000/vid/',
